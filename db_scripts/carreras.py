...
def importar_carreras_sin_repetir(csv_filepath, db_filepath, table_name='propuestas'):
    """
...
if __name__ == '__main__':
    ...
    importar_carreras_sin_repetir(csv_input_path, db_output_path, 'propuestas')
